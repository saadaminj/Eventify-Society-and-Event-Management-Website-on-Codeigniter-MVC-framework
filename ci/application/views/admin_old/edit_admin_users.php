            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <?php }?>
                        <form id="form_advanced_validation" method="POST" action="<?php echo SITE_URL.'admin/admin_users_admin/edit/'.$final_data[0]['id'];?>" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                       <input type="password" class="form-control" name="password"/>
                                        ...
                                        <small>If you do not want to change password leave it blank.</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="first_name" value="<?php echo $final_data[0]['first_name'];?>" required/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="last_name" value="<?php echo $final_data[0]['last_name'];?>" required/>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control show-tick" style="margin-top: 27px;" name="status" required>
                                    <option value="1" <?php echo ($final_data[0]['status'] == 1)?'selected':'';?>>Active</option>
                                    <option value="0" <?php echo ($final_data[0]['status'] == 0)?'selected':'';?>>In active</option>
                                </select>
                            </div>
                        </div>
