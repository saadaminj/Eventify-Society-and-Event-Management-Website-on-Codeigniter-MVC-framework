                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <textarea disabled rows='20' class="form-control" name="text" required><?php echo $final_data[0]['text'];?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <center>
                                <a class="btn mt-5 pt-5 btn-lg waves-effect btn-danger" href='<?php echo SITE_ADMIN_URL.'cms/index'?>' style='margin-right: 10px;'>Cancel
                                </a>
                            </center>
                        </form>
                    </div>
