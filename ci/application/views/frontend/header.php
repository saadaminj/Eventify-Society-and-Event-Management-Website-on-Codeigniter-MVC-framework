			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-11 text-right menu-10">
						<ul>
							<li <?php echo $active; ?>><a href="<?php echo base_url()?>">Home</a></li>
							...
							<li <?php echo $active1; ?>><a href="<?php echo base_url().'contact-us'?>">Contact</a></li>
							<li class="btn-cta"><a href="<?php echo base_url().'signup'?>"><span>Login</span></a></li>
						</ul>
					</div>
				</div>
